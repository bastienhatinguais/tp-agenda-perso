...
public class FixedTerminationEventTest {
        ...
        FixedTerminationEvent fixedTermination = new FixedTerminationEvent("Fixed termination weekly",
                        nov_1__2020_22_30,
                        min_120, ChronoUnit.WEEKS, jan_5_2021);

        // A Weekly Repetitive event ending after a give number of occurrrences
        FixedTerminationEvent fixedRepetitions = new FixedTerminationEvent("Fixed termination weekly",
                        nov_1__2020_22_30,
                        min_120, ChronoUnit.WEEKS, 10);
        ...
        public void canCalculateTerminationDateFromNumberOfOccurrences() {
                ...
                assertEquals(termination, fixedRepetitions.getTerminationDate(),
                                "Cet événement doits se terminer le 3 janvier");
        }
        ...
        public void eventIsNotInDayBefore() {
                assertFalse(fixedTermination.isInDay(nov_1_2020.minus(1, ChronoUnit.DAYS)),
                                "Un événement n'a pas lieu avant son jour de début");
                assertFalse(fixedRepetitions.isInDay(nov_1_2020.minus(1, ChronoUnit.DAYS)),
                                "Un événement n'a pas lieu avant son jour de début");
        }

        @Test
        public void eventOccurs10WeeksAfter() {
                assertTrue(fixedTermination.isInDay(nov_1_2020.plus(6, ChronoUnit.WEEKS)),
                                "Cet événement se produit toutes les semaines");
                assertTrue(fixedRepetitions.isInDay(nov_1_2020.plus(6, ChronoUnit.WEEKS)),
                                "Cet événement se produit toutes les semaines");
        }
        ...
        public void eventIsNotInExceptionDays() {
                ...
                assertTrue(fixedTermination.isInDay(nov_1_2020.plus(1, ChronoUnit.WEEKS)),
                                "Cet événement se produit toutes les semaines");
                assertFalse(fixedTermination.isInDay(nov_1_2020.plus(2, ChronoUnit.WEEKS)),
                                "Cet événement ne se produit pas à W+2");
                assertTrue(fixedTermination.isInDay(nov_1_2020.plus(3, ChronoUnit.WEEKS)),
                                "Cet événement se produit toutes les semaines");
                assertFalse(fixedTermination.isInDay(nov_1_2020.plus(4, ChronoUnit.WEEKS)),
